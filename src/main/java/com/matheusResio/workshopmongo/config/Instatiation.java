...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, Instant.parse("2018-03-23T16:22:01Z"), "Bom dia", "Acordei feiz hoje", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", Instant.parse("2018-03-21T16:32:43Z"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", Instant.parse("2018-03-22T03:12:23Z"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", Instant.parse("2018-03-23T16:32:43Z"), new AuthorDTO(alex));
